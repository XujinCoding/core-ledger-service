...
public enum BusinessCode {
    ...
    // ==================== 短信模块 (7000-7999) ====================
    /** 短信发送过于频繁 */
    SMS_SEND_TOO_FREQUENT(7001, "短信发送过于频繁，请60秒后再试"),

    /** 短信发送次数超限 */
    SMS_SEND_LIMIT_EXCEEDED(7002, "今日短信发送次数已达上限"),

    /** 短信发送失败 */
    SMS_SEND_FAILED(7003, "短信发送失败，请稍后重试"),

    /** 验证码错误 */
    SMS_CODE_INVALID(7004, "验证码错误"),

    /** 验证码已过期 */
    SMS_CODE_EXPIRED(7005, "验证码已过期，请重新获取"),

    /** 验证码验证次数超限 */
    SMS_VERIFY_LIMIT_EXCEEDED(7006, "验证码验证次数过多，请15分钟后重试"),

    /** 验证码必填 */
    SMS_CODE_REQUIRED(7007, "修改手机号需要验证码"),
